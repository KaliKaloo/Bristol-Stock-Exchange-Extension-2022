        ...
        if self.optmzr == 'PRSH':
            ...
            if actv_lifetime >= self.strat_wait_time:
                ...
                if self.diffevol['de_state'] == 'active_s0':
                    ...
                    # move bestStrat to beginning of population P
                    self.diffevol['population_P'].insert(0, self.diffevol['population_P'].pop(self.diffevol['population_P'].index(bestStrat)))
                    ...
                    # randomly choose xr1  from current population P
